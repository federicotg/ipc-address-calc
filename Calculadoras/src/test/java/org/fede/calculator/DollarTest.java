...
public class DollarTest {
    ...
    public void inflate() throws NoSeriesDataFoundException {
        MoneyAmountSeries unlp = readSeries("unlp.json");
    ...
    public void historicDollar() throws NoSeriesDataFoundException {
        ...
        MoneyAmountSeries expected = new SortedMapMoneyAmountSeries(Currency.getInstance("ARS"));
    ...
    public void averages() throws NoSeriesDataFoundException {
        MoneyAmountSeries series = readSeries("unlp.json");
        MoneyAmountSeries averaged = new SimpleAggregation(6).average(readSeries("unlp.json"));
    ...
    public void limits() throws NoSeriesDataFoundException {
        ...
        MoneyAmountSeries series = readSeries("lifia.json");
...
//        assertEquals(ARS_INFLATION.getTo().getMonth(), inflatedSeries.getTo().getMonth());
    ...
    public void seriesAddition() throws NoSeriesDataFoundException {
        MoneyAmountSeries lifia = readSeries("lifia.json");
        MoneyAmountSeries unlp = readSeries("unlp.json");
    ...
    public void ahorros() throws NoSeriesDataFoundException {
        //9 2002
        MoneyAmountSeries pesos = readSeries("ahorros-peso.json");
        MoneyAmountSeries dolares = readSeries("ahorros-dolar.json");
    ...
    public void exchangeFailing() throws NoSeriesDataFoundException {
        ...
        MoneyAmountSeries usdSeries = new SortedMapMoneyAmountSeries(Currency.getInstance("USD"));
