    ...
    public void dollar() {
        ...
        try {
            ...
            try (ExecutorService executor = Executors.newVirtualThreadPerTaskExecutor()) {
                ...
                futures.add(this.ppiItem("CCL " + letra1 + " nov.", new PPIFXParams(letra1 + "C", "X23N3", LETRAS, INMEDIATA, newFee), executor));
                futures.add(this.ppiItem("MEP " + letra1 + " nov.", new PPIFXParams(letra1 + "D", "X23N3", LETRAS, INMEDIATA, newFee), executor));
