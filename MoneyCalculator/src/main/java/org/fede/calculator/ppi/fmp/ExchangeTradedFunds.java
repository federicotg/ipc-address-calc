...
public class ExchangeTradedFunds {
    ...
    private static final String CSPX = "CSPX.L";
    private static final String RTWO = "RTWO.L";
    private static final String EIMI = "EIMI.L";
    private static final String IWDA = "IWDA.L";
    private static final String MEUD = "MEUD.PA";
    private static final String MEUS = "MEUS.L";
    private static final String XRSU = "XRSU.L";
    ...
    private ForeignExchange useEur() throws IOException, URISyntaxException, InterruptedException {
    ...
    public void list() throws IOException, URISyntaxException, InterruptedException {
        ...
        if (response.statusCode() == 200) {
            ...
            Stream.concat(
                    etfs.stream().map(etf -> MessageFormat.format("{0} {1} {2}", etf.symbol(), this.currencySymbol(etf.symbol()), etf.price())),
                    Stream.of("USD/EUR $ " + this.format.numberLong(this.useEur().ask())))
                    .sorted()
