...
public class ConsoleReports {
    ...
    private void etf() {
        ...
        try {
            new ExchangeTradedFunds(this.console, this.format, new ObjectMapper()
                    .setPropertyNamingStrategy(PropertyNamingStrategies.LOWER_CAMEL_CASE), new SingleHttpClientSupplier()).list();
        } catch (Exception ex) {
